...
export const Card: React.FC<CardInterface> = (props) => {
    ...
    return <div>
        ...
        <h6
            className={`md:text-[20px] text-[16px] text-center leading-[24px] tracking-[-0.06px] ${type === "how-it-works" ? 'text-primaryAccent' : 'text-[#101D2C]'} font-medium mt-[17px] max-w-[200px] md:min-h-[48px] mx-auto`}
        >
            {title}
        </h6>
        <p
            className={`md:text-[17px] text-[14px] text-center leading-[27px] tracking-[0.19px] ${type === "how-it-works" ? 'text-primaryAccent' : 'text-[#101D2C]'} font-light mt-[10px]`}
        >
            {description}
        </p>
    </div>;
