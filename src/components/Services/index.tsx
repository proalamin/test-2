                        ...
                        return <div key={index}
                            ...
                            <div
                                ...
                                <Img src={service.icon}
                                     alt={service.title}
                                     className="md:w-auto md:h-auto w-[60.3px] ease-linear duration-300 non-hover"/>
                                <Img src={service.iconLight}
                                     alt={service.title}
                                     className="md:w-auto md:h-auto w-[60.3px] ease-linear duration-300 hover hidden"/>
                            </div>
                            <p
