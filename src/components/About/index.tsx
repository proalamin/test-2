    ...
    return <div
        ...
        <div className="flex md:flex-row flex-col items-center md:gap-[59.5px] md:mb-[64px] mb-[53px]">
            <div className="flex-1 max-w-[541.5px]">
                ...
                <h2 className="xl:text-[35px] text-[24px] md:text-left text-center leading-[44px] tracking-[-0.47px] font-semibold text-[#101D2C] mb-[20px]">
                    About <span className="text-primary underline underline-offset-[8px]">SearchMyExpert</span>
                </h2>
                <p className="xl:text-[19px] text-[14px] leading-[30px] pb-[8px] md:text-left text-center font-semibold text-[#111B35]">
                    Unlock Expertise at Your Fingertips!
                </p>
                <p className="xl:text-[19px] text-[13px] leading-[30px] font-light text-[#111B35] mb-[42px] md:text-left text-center">
            ...
            <div className="xl:w-[839px] md:w-[500px] sm:w-full">
        ...
        <div className="flex md:flex-row flex-col md:gap-[62px]">
            <div className="flex-1 md:m-0 mb-[21px] md:text-left text-center">
                <p className="xl:text-[19px] text-[14px] leading-[30px] font-light pb-[10px]">
                ...
                <p className="xl:text-[19px] text-[14px] leading-[30px] font-light">
            ...
            <div className="flex-1 md:text-left text-center">
                <p className="xl:text-[19px] text-[14px] leading-[30px] font-semibold pb-[10px]">
                    {/* eslint-disable-next-line react/no-unescaped-entities */}
