...
export const WhyChooseUs: React.FC<WhyChooseUsInterface> = (props) => {
    ...
    >
        <div
            className="relative max-w-[2240px] mx-auto xl:px-[100px] px-[50px]  xl:pt-[139px] md:pt-[90px] xl:pb-[141px] md:pb-[90px]">
            ...
            <div className="max-w-[1385px] mx-auto why-choose-data-section relative">
                <div className="flex md:flex-row flex-col">
                    <div className="xl:max-w-[320px] md:max-w-[290px] md:m-0 mb-[50px]">
                        ...
                        <h2 className="xxl:text-[35px] xl:text-[30px] text-[24px] sm:leading-[44px] leading-[35px] tracking-[-0.44px] font-semibold pb-[19px] text-primaryAccent">
                            {subtitle}
                        </h2>
